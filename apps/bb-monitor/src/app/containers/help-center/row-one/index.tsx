...
import { Row, Col, Heading, Nav, NavLink } from "@stevenr/components";
                    ...
                    <Col sm={6} mt={["20px", 0]}>
                        <InstallBox
                            ...
                            items={[
                                ...
                                {
                                    text:
                                        "Example of bootsrap page using " +
                                        "navbar",
                                    path: "#!",
                                },
                            ]}
                    ...
                    <Col sm={6} mt={["20px", "30px"]}>
                        <InstallBox
                            ...
                            items={[
                                {
                                    text:
                                        "Minimize sass to css without" +
                                        " bootstrap",
                                    path: "#!",
                                },
                                {
                                    text:
                                        "Adding more utilities classes in " +
                                        "sass",
                                    path: "#!",
                                },
                            ]}
