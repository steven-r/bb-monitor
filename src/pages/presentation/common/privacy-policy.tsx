			...
			<Page container='md'>
				<div className='row'>
					<div className='col-12'>
						<h2 className='text-muted'>Privacy Policy</h2>
						...
						<h2 className='text-muted'>Interpretation and Definitions</h2>
						<h3 className='text-muted'>Interpretation</h3>
						<p>
						...
						<h3 className='text-muted'>Definitions</h3>
						...
						<ul>
							...
							<li>
								<p>
									...
									in this Agreement) refers to BitBurner-Monitor.
								</p>
							</li>
							<li>
								<p>
							...
							<li>
								<p>
									<strong>Website</strong> refers to BitBurner-Monitor, accessible
									from{' '}
									<a
										href='http://bb-monitor.com'
						...
						<h2 className='text-muted'>Collecting and Using Your Personal Data</h2>
						<h3 className='text-muted'>Types of Data Collected</h3>
						...
						<h4 className='text-muted'>Usage Data</h4>
						...
						<h4 className='text-muted'>Tracking Technologies and Cookies</h4>
						<p>
						...
						<h3 className='text-muted'>Use of Your Personal Data</h3>
						...
						<h3 className='text-muted'>Retention of Your Personal Data</h3>
						<p>
						...
						<h3 className='text-muted'>Transfer of Your Personal Data</h3>
						<p>
						...
						<h3 className='text-muted'>Disclosure of Your Personal Data</h3>
						<h4 className='text-muted'>Business Transactions</h4>
						<p>
						...
						<h4 className='text-muted'>Law enforcement</h4>
						<p>
							Under certain circumstances, the Company may be required to disclose
							Your Personal Data if required to do so by law or in response to valid
							requests by public authorities (e.g. a court or a government agency).
						</p>
						<h4 className='text-muted'>Other legal requirements</h4>
						<p>
						...
						<h3 className='text-muted'>Security of Your Personal Data</h3>
						<p>
						...
						<h2 className='text-muted'>Children's Privacy</h2>
						<p>
						...
						<h2 className='text-muted'>Links to Other Websites</h2>
						<p>
						...
						<h2 className='text-muted'>Changes to this Privacy Policy</h2>
						<p>
						...
						<ul>
							<li>By email: stephen.reindl@gmail.com</li>
						</ul>
					</div>
				</div>
			</Page>
