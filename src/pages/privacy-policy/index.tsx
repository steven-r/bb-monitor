...
const PrivacyPolicy: FC = () => {
    return (
        <Layout pageHeader={{ title: 'Privacy Policy' }}>
            <Text as="p">Last updated: June 25, 2022</Text>
            <Text as="p">
            ...
            <Heading level={1}>Interpretation and Definitions</Heading>
            ...
            <Text as="p">For the purposes of this Privacy Policy:</Text>
            <ul>
                <li>
                    <Text as="p">
                ...
                <li>
                    <Text as="p">
                        <strong>Country</strong> refers to: Nordrhein-Westfalen,
                        Germany
                    </Text>
                </li>
                <li>
                ...
                <li>
                    <Text as="p">
                        <strong>Website</strong> refers to BitBurner-Monitor,
                        accessible from{' '}
                        <a
                            href="https://www.bb-monitor.de"
                            rel="external nofollow noopener noreferrer"
                            target="_blank"
                        >
                            https://www.bb-monitor.de
                        </a>
                    </Text>
                </li>
                <li>
            ...
            <Heading level={1}>Collecting and Using Your Personal Data</Heading>
            ...
            <Heading level={3}>Tracking Technologies and Cookies</Heading>
            <Text as="p">
            ...
            <ul>
                <li>
                    ...
                    <Text as="p">Type: Session Cookies</Text>
                    <Text as="p">Administered by: Us</Text>
                    <Text as="p">
                ...
                <li>
                    ...
                    <Text as="p">Type: Persistent Cookies</Text>
                    <Text as="p">Administered by: Us</Text>
                    <Text as="p">
            ...
            <Heading level={2}>Disclosure of Your Personal Data</Heading>
            <Heading level={3}>Business Transactions</Heading>
            <Text as="p">
            ...
            <Heading level={3}>Law enforcement</Heading>
            <Text as="p">
            ...
            <Heading level={3}>Other legal requirements</Heading>
            <Text as="p">
            ...
            <Heading level={1}>Children's Privacy</Heading>
            <Text as="p">
            ...
            <Heading level={1}>Links to Other Websites</Heading>
            <Text as="p">
            ...
            <Heading level={1}>Changes to this Privacy Policy</Heading>
            <Text as="p">
