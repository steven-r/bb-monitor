import React, { Children, forwardRef, FC, ReactNode, useState, ReactElement, memo } from 'react';
...
interface ICardFooterLeftProps {
	tag?: string | null;
	className?: string;
	children: ReactNode;
}
...
interface ICardFooterProps {
	tag?: string | null;
	className?: string;
	children: ReactElement<ICardFooterLeftProps> | ReactElement<ICardFooterRightProps>;
	size: 'sm' | null | 'lg';
	borderSize?: null | 0 | 1 | 2 | 3 | 4 | 5;
	borderColor?: null | TColor;
	[key: string]: any;
