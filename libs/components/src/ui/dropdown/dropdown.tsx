...
import { useClickOutside } from "@stevenr/shared/hooks";
...
export const DropdownToggle: FC<PropsWithChildren<ButtonProps>> = (props) => {
...
export const DropdownMenu: FC<PropsWithChildren<IDropMenu>> = ({
    children,
    show,
    direction,
    className,
...
export const DropdownItem: FC<PropsWithChildren<IDropItem>> = ({
    children,
    path,
    className,
    active,
