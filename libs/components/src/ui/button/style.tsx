...
const buttonStyles = css<IProps>`
  ...
  ${(props) =>
    ...
    ${(props) =>
        ...
        props.$color === 'github' &&
    css`
      background-color: ${themeGet('colors.github')};
      border-color: ${themeGet('colors.github')};
      color: #fff;
      &:hover {
        background-color: ${tinycolor2(themeGet('colors.github')(props))
          .darken(10)
          .toString()};
        border-color: ${tinycolor2(themeGet('colors.github')(props))
          .darken(14)
          .toString()};
        color: #fff;
      }
      ...
      &:focus {
        ...
        border-color: ${tinycolor2(themeGet('colors.github')(props))
          ...
          .toString()};
        box-shadow: 0 0 0 0.2rem
          ${tinycolor2(themeGet('colors.github')(props))
            .setAlpha(0.5)
            .toRgbString()};
      }
    `}
