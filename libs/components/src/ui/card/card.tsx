...
export const CardBody: FC<PropsWithChildren<ICardBodyProps>> = ({
    children,
    className,
    ...restProps
}) => {
...
export const CardTitle: FC<PropsWithChildren<ICardTitleProps>> = ({
    children,
    className,
    as,
    ...restProps
...
export const CardText: FC<PropsWithChildren<ICardCommonProps>> = ({
    children,
    className,
    ...restProps
}) => {
...
export const CardSubtitle: FC<PropsWithChildren<ICardCommonProps>> = ({
    children,
    className,
    ...restProps
}) => {
...
export const CardLink: FC<PropsWithChildren<ICardLinkProps>> = ({
    children,
    className,
    path,
    ...restProps
...
export const CardHeader: FC<PropsWithChildren<ICardHeaderProps>> = ({
    children,
    className,
    variant,
    ...restProps
...
export const CardFooter: FC<PropsWithChildren<ICardFooterProps>> = ({
    children,
    className,
    ...restProps
}) => {
...
export const CardImageOverlay: FC<PropsWithChildren<ICardCommonProps>> = ({
    children,
    className,
    ...restProps
}) => {
...
export const CardGroup: FC<PropsWithChildren<ICardCommonProps>> = ({
    children,
    className,
    ...restProps
}) => {
...
export const CardDeck: FC<PropsWithChildren<ICardCommonProps>> = ({
    children,
    className,
    ...restProps
}) => {
...
export const CardColumns: FC<PropsWithChildren<ICardCommonProps>> = ({
    children,
    className,
    ...restProps
}) => {
