...
import { FlexboxProps, SpaceProps, TypographyProps } from "@stevenr/shared";
...
export const Nav: FC<PropsWithChildren<INav>> = ({
    children,
    className,
    pills,
    align,
...
export const NavLink: FC<PropsWithChildren<ILink>> = ({
    children,
    className,
    path,
    active,
