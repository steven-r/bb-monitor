...
import { SpaceProps, BorderProps, TypographyProps } from "@stevenr/shared";
...
export const Container: FC<PropsWithChildren<IProps>> = ({ className, ...props }) => {
...
export const Col: FC<PropsWithChildren<IColProps>> = ({ className, ...props }) => {
